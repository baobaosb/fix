			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-10 col-sm-6 col-md-5 col-lg-4 m-auto pb-5 pb-md-0" style="z-index: 10000;">
						<p><img alt="image" class="img-fluid rounded-0" src="https://cdn.jsdelivr.net/gh/froala/design-blocks@2.0.1/dist/imgs//draws/iphone-hand.svg"></p>
					</div>

					<div class="col-12 ml-md-auto col-md-7 col-lg-6 pb-5 pb-md-0" style="z-index: 10000;">
						<p><img alt="image" class="fdb-icon fr-fic fr-dii" src="https://cdn.jsdelivr.net/gh/froala/design-blocks@2.0.1/dist/imgs//icons/gift.svg"></p>
						<h1>广青网络数据中心</h1>
						<p class="lead">学校的网络、电话又出现问题啦？请联系我们报修吧。</p>
						<p class="mt-4"><a class="btn btn-secondary" href="repair.jsp">报修</a> <a class="btn btn-dark ml-3" href="retrieve.jsp">查询</a></p>
					</div>
				</div>
			</div>
		</section>
		<footer class="fdb-block footer-small fp-active" data-block-type="footers" data-id="3">
			<div class="container">
				<div class="row text-center">
					<div class="col fr-box fr-inline" role="application" style="z-index: 10000;">
