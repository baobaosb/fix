...
<section class="fdb-block pt-0" data-block-type="contacts" data-id="4" draggable="true">
  <div class="container">
    <div class="row mt-5">
      <div class="col-12 col-md-6 col-lg-5">
        ...
        <p class="lead">
          <strong>Phone:</strong> +020 36 123 1232
        </p>
      </div>

      <div class="col-12 col-md-6 ml-auto pt-5 pt-md-0">
        <form action="user-repair" method="post">
          <div class="row">
            <div class="col">
              <input type="text" name="order.name" class="form-control" placeholder="姓名">
            </div>
            <!--<div class="col">
		  ...
		  <div class="row mt-4">
		  	<div class="col">
		  		<input type="text" name="order.stuId" class="form-control" placeholder="学号 *查询使用" />
		  	</div>
		  </div>

          <div class="row mt-4">
            <div class="col">
              <input type="text" name="order.mobile" class="form-control" placeholder="联系电话">
            </div>
          </div>
          ...
          <div class="row mt-4">
            <div class="col">
              <input type="text" name="order.place" class="form-control" placeholder="维修地点">
            </div>
          </div>
          <div class="row mt-4">
            <div class="col">
              <textarea class="form-control" name="order.descrip" rows="3" placeholder="具体什么情况？是怎么坏的？什么时候会的？"></textarea>
            </div>
          </div>
          <div class="row mt-4">
            <div class="col">
...
<footer class="fdb-block footer-small fp-active" data-block-type="footers" data-id="2">
  <div class="container">
